...
#ifndef V5_ANDRELUIS_ERIKSOARES_RAFAELCOSTA_ROBERTOALVES_H
#define V5_ANDRELUIS_ERIKSOARES_RAFAELCOSTA_ROBERTOALVES_H
...
// Monta o ranking de afinidade em torno de uma pessoa de referência usando um vetor de ponteiros
// (Pessoa **) que aponta direto pros registros originais, sem copiar dados nem alterar o cadastro.
